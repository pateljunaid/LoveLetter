...
//
////******
//// this is an activity which will display the results of playing the Three Card to the user
////******
//
...
//        //the actual functionality has already been done by the Three class. This is only to show the user what has happened
