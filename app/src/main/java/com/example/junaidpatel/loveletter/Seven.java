...
/**
 * This class creates the Seven card which contains functionality and attributes unique to this class
...
public class Seven implements Card {
    ...
    public int specialFunction(Player currentPlayer, Player targetPlayer1, Player targetPlayer2, Player targetPlayer3, int length, Card[] deck, int tag, int cardChoice, int guardChoice) {
        ...
        System.out.println(currentPlayer.getPlayerName() + " has discarded a Seven");
        return length;
    }
}